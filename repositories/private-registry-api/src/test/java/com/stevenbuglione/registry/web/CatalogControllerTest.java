...
class CatalogControllerTest {
    ...
    void setUp() {
        ...
        lenient().when(identities.accessContext(nullable(Authentication.class))).thenReturn(accessContext);
        mvc = MockMvcBuilders.standaloneSetup(new CatalogController(catalog, identities))
