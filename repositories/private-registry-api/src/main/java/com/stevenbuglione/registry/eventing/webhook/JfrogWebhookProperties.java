...
public record JfrogWebhookProperties(
    ...
    private static final Set<String> DEFAULT_REPOSITORIES = Set.of(
            "iac-provider-release-local", "iac-module-release-local", "iac-catalog-release-local");
    private static final Set<String> DEFAULT_PATH_PREFIXES = Set.of(
            "v1/",
            "hashicorp/",
            "datadog/",
            "grafana/",
    ...
    public JfrogWebhookProperties {
        ...
        allowedRepositories = allowedRepositories == null || allowedRepositories.isEmpty()
