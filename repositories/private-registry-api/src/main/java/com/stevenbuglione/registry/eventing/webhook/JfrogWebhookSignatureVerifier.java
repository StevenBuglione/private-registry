...
public class JfrogWebhookSignatureVerifier {
    ...
    public boolean isValid(byte[] payload, String suppliedSignature, String secret) {
        if (suppliedSignature == null || suppliedSignature.isBlank() || secret == null || secret.isBlank()) {
            return false;
        }
    ...
    private static byte[] decode(String suppliedSignature) {
        var value = suppliedSignature.startsWith("sha256=")
